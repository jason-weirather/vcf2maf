...
This docker is not set up or tested for executing VEP. 

It is only being constructed for converting a VEP vcf file to an MAF file.

See https://github.com/mskcc/vcf2maf for the real deal and credit them if you use this please.
